...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-desktop/gnome-desktop-2.16.3.ebuild,v 1.2 2007/02/09 22:07:59 uberlord Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/makefile-patch.patch
	epatch ${FILESDIR}/configure-patch.patch
