...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/driftnet/driftnet-0.1.6-r3.ebuild,v 1.8 2007/07/22 07:45:55 pva Exp $
...
SRC_URI="mirror://debian/pool/main/d/driftnet/${MY_P}.orig.tar.gz
	mirror://debian/pool/main/d/driftnet/${MY_P}-7.diff.gz"
...
src_unpack() {
	...
	sed -i 's/`pkg-config --cflags libpng`//' Makefile || die "sed remove libpng failed"
}
