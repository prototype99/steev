...
MY_P="stackless-251-export"
S="${WORKDIR}/${MY_P}"
#http://www.stackless.com/binaries/stackless-251-export.tar.bz2
DESCRIPTION="Python is an interpreted, interactive, object-oriented programming
language. This includes the stackless addons/patches."
HOMEPAGE="http://www.stackless.com/"
SRC_URI="http://www.stackless.com/binaries/${MY_P}.tar.bz2
	mirror://gentoo/python-gentoo-patches-2.5.1.tar.bz2"
...
src_unpack() {
	...
	if tc-is-cross-compiler ; then
		...
		rm "${WORKDIR}/2.5.1"/*_all_crosscompile.patch
	fi

	EPATCH_SUFFIX="patch" epatch "${WORKDIR}/2.5.1"
	...
	epatch ${FILESDIR}/${PN}-gnustack.patch
	eautoreconf
}
...
src_compile() {
	...
	use x86 \
		&& myconf="${myconf} --enable-stacklessfewerregisters"
